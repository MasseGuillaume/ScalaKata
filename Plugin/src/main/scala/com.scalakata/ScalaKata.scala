		...
		inConfig(Backend)(
			...
			Seq(
				...
				libraryDependencies ++= Seq(
					"com.scalakata" % s"backend_${scalaBinaryVersion.value}" % "0.2.0",
					"com.scalakata" % s"eval_${scalaBinaryVersion.value}" % "0.2.0",
					"com.scalakata" % "frontend" % "0.2.0"
				)
			)
		) ++
		inConfig(Kata)(
			...
			Seq(
				...
				libraryDependencies ++= Seq(
					"com.scalakata" % s"macro_${scalaBinaryVersion.value}" % "0.2.0",
